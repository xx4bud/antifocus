  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        range_start: cn(
          "relative isolate z-0 rounded-s-(--cell-radius) bg-muted after:absolute after:inset-e-0 after:inset-y-0 after:w-4 after:bg-muted",
          defaultClassNames.range_start
        ),
        range_middle: cn("rounded-none", defaultClassNames.range_middle),
        range_end: cn(
          "relative isolate z-0 rounded-e-(--cell-radius) bg-muted after:absolute after:inset-s-0 after:inset-y-0 after:w-4 after:bg-muted",
...
function CalendarChevron({
  ...
  orientation,
  ...props
}: ComponentProps<typeof IconChevronDown> & {
